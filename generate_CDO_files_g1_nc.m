...
%% write 2D and 1d x,y
wnc(xcenters-proj_info.falseeasting,agrid.xyOutputFileName,'x2','m','grid center x-coordinate',{'x','y'},0,'NETCDF4')
wnc(ycenters-proj_info.falsenorthing,agrid.xyOutputFileName,'y2','m','grid center y-coordinate',{'x','y'},0,'NETCDF4')

wnc(squeeze(xcenters(:,1))-proj_info.falseeasting,agrid.xyOutputFileName,'x1','m','grid center x-coordinate','x',0,'NETCDF4')
wnc(squeeze(ycenters(1,:))-proj_info.falsenorthing,agrid.xyOutputFileName,'y1','m','grid center y-coordinate','y',0,'NETCDF4')
